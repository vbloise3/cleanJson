...
## @type: DataSource
## @args: [database = "blog-db", table_name = "taxi_blogtaxi", transformation_ctx = "datasource0"]
## @return: datasource0
## @inputs: []
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "blog-db", table_name = "taxi_blogtaxi", transformation_ctx = "datasource0")
## @type: ApplyMapping
...
##----------------------------------
datasink4 = glueContext.write_dynamic_frame.from_options(frame = customDynamicFrame, connection_type = "s3", connection_options = {"path": "s3://go-lambda-bucket"}, format = "parquet", transformation_ctx = "datasink4")
job.commit()